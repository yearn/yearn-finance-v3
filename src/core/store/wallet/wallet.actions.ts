...
export const walletChange = createAction<{ walletName: string }>(
  'wallet/walletChange'
);
export const addressChange = createAction<{ address: string }>(
  'wallet/addressChange'
);
export const networkChange = createAction<{ network: number }>(
  'wallet/networkChange'
);
export const balanceChange = createAction<{ balance: string }>(
