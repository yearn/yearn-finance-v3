// NOTE: file coppied from metamask since its not exported in bundle
// https://github.com/MetaMask/mobile-provider/blob/main/src/inpage/ReactNativePostMessageStream.js
...
PostMessageStream.prototype._onMessage = function (event) {
  ...
  if (event.source !== this._targetWindow && window === window.top) {
    return;
  }
