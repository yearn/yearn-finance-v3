...
export const getEnv = memoize((): Env => {
  const {
    ...
    REACT_APP_USE_VEYFI_ROUTES,
    REACT_APP_ALLOW_DEV_MODE,
    REACT_APP_ETHEREUM_PROVIDER_HTTPS,
    REACT_APP_FANTOM_PROVIDER_HTTPS,
    REACT_APP_ARBITRUM_PROVIDER_HTTPS,
    REACT_APP_OPTIMISM_PROVIDER_HTTPS,
  ...
  return {
    ...
    USE_VEYFI_ROUTES: REACT_APP_USE_VEYFI_ROUTES === 'true',
    ALLOW_DEV_MODE: REACT_APP_ALLOW_DEV_MODE === 'true',
    ETHEREUM_PROVIDER_HTTPS: REACT_APP_ETHEREUM_PROVIDER_HTTPS || undefined,
    FANTOM_PROVIDER_HTTPS: REACT_APP_FANTOM_PROVIDER_HTTPS || undefined,
    ARBITRUM_PROVIDER_HTTPS: REACT_APP_ARBITRUM_PROVIDER_HTTPS || undefined,
    OPTIMISM_PROVIDER_HTTPS: REACT_APP_OPTIMISM_PROVIDER_HTTPS || undefined,
    CUSTOM_PROVIDER_HTTPS: REACT_APP_CUSTOM_PROVIDER_HTTPS || 'http://127.0.0.1:8545/',
    INFURA_PROJECT_ID: REACT_APP_INFURA_PROJECT_ID || undefined,
    ETHERSCAN_API_KEY: REACT_APP_ETHERSCAN_API_KEY || undefined,
    ALCHEMY_API_KEY: REACT_APP_ALCHEMY_API_KEY || undefined,
    BLOCKNATIVE_KEY: REACT_APP_BLOCKNATIVE_KEY || undefined,
    FORTMATIC_KEY: REACT_APP_FORTMATIC_KEY || undefined,
    PORTIS_KEY: REACT_APP_PORTIS_KEY || undefined,
