...
describe('Errors', () => {
  describe('parseError', () => {
    it.each`
      ...
      ${'EthersError: POPULATING_TRANSACTION'}       | ${new EthersError('error message', EthersError.POPULATING_TRANSACTION)}              | ${{ code: EthersError.POPULATING_TRANSACTION, message: 'Error populating transaction. Make sure you have enough ETH for gas fees.', name: 'ethers' }}
